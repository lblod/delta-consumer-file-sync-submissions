...
export const CONTAINER_TYPE = 'http://www.semanticdesktop.org/ontologies/2007/03/22/nfo#DataContainer';
export const FILE_SYNC_TASK_OPERATION = 'http://redpencil.data.gift/id/jobs/concept/TaskOperation/deltas/consumer/fileSyncing';
export const FILE_DELETE_TASK_OPERATION = 'http://redpencil.data.gift/id/jobs/concept/TaskOperation/deltas/consumer/fileDeleting';
...
export const FILE_SYNCED = 'http://redpencil.data.gift/id/concept/SyncStatus/file/synced';
